...
const tourSchema = new mongoose.Schema({
  name: {
    ...
    //validate: [validator.isAlpha, 'A tour name must only include letters'] external validator
  },
  slug: String,
  duration: {
    type: Number,
  ...
  priceDiscount: {
    type: Number,
    validate: {
      validator: function(val) { // validator only works with this keyword on create not update 
...
tourSchema.pre(/^find/, function() {
  // populate will embedd the guides document into the tour 
  this.populate({
    path: 'guides',
...
/*
  ...
  urSchema.post('save', function(doc) {
  console.log(doc)
})*/
